          ...
          <a href="{{ route('home') }}" class="d-block" style="text-decoration: none;">{{ $profile->company_name }}</a>
            ...
            <nav class="mt-2 mb-4">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li
                        class="nav-item {{ request()->routeIs('expenses.*') || request()->routeIs('suppliers.*') ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('expenses.*') || request()->routeIs('suppliers.*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview pl-3">
                            <li class="nav-item">
                                <a href="{{ route('suppliers.index') }}"
                                    class="nav-link pl-2 {{ request()->routeIs('suppliers.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('expenses-categories.index') }}"
                                    class="nav-link pl-2 {{ request()->routeIs('expenses-categories.*') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('expenses.index') }}"
                                    class="nav-link pl-2 {{ request()->routeIs('expenses.*') ? 'active' : '' }}">
                                    <i class="fas fa-box mr-1"></i>
                                    <p>Expenses</p>
                                </a>
                            </li>
