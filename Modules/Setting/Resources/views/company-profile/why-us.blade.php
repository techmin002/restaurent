                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($whyus as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('upload/iamages/whyus/'.$value->image) }}"
                                         height="80" width="80" 
                                ...
                                <td class="text-center">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Edit Whyus </h5>
                                                ...
                                                <form action="{{ route('whyus.update', $value->id) }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" rows="3" class="form-control" required>{{ $value->description }}</textarea>
                                                        </div>

                                                        <div class="form-group">
                                                            <label>Image</label>
                                                            <input type="file" name="image" class="form-control">
                                                            <img src="{{ asset('upload/images/whyus/'.$value->image) }}"
                                    ...
                                    <!-- Delete -->
                                    <a href="{{ route('whyus.delete',$value->id) }}"
