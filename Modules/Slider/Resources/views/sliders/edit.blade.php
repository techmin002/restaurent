    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <form id="product-form" action="{{ route('sliders.update', $slider->id) }}" method="POST"
                            ...
                            <div class="card">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="link" class="form-control"
                                                    placeholder="Enter Link" value="{{ $slider->link }}">
                                                @error('link')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" class="summernote" placeholder="Enter description" >{{$slider->description}}</textarea>
                                        @error('description')
                                        <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="image">Image <small>( 1280 x 540 )</small></label>
                                                ...
                                                <img src="{{ asset('upload/images/sliders/' . $slider->image) }}"
