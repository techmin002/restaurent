    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border-radius: 8px;">
            <div class="modal-header justify-content-center" style="background-color: #007bff; color: #ffff;">
                <h4 class="modal-title" id="editModalLabel{{ $res->id }}">Edit Branch</h4>
                <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('restaurents.update', $res->id) }}" class="needs-validation" novalidate id="branchEditForm{{ $res->id }}" method="post">
                @csrf
                @method('PUT')
                    ...
                    <div class="container">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" placeholder="Enter branch name" type="text" name="name" id="name{{ $res->id }}" value="{{ $res->name }}" required>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" placeholder="Enter branch email" type="email" name="email" id="email{{ $res->id }}" value="{{ $res->email }}">
                            </div>
                        </div>
