                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                @include('restaurent::customers.create')
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($customers as $key => $customer)
                                            @php
                                                $url = url("office/order/{$customer['id']}");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @include('restaurent::customers.edit')
                                                    <a href="{{ route('customers.show', $customer->id) }}"
                                                        class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                                    <button id="delete" class="btn btn-danger btn-sm"
                                                        onclick="event.preventDefault();if (confirm('Are you sure? It will delete the data permanently!')) {document.getElementById('destroy{{ $customer->id }}').submit()}">
                                                        <i class="fa fa-trash"></i>
                                                        <form id="destroy{{ $customer->id }}" class="d-none"
