    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 8px;">
            <div class="modal-header justify-content-center" style="background-color: #007bff; color: #ffff;">
                <h4 class="modal-title fs-5" id="staticBackdropLabel">Create Office/Shop </h4>
                <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('offices.store') }}" class="needs-validation" novalidate id="expenseForm"
                method="post">
                @csrf
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-12" data-select2-id="select2-data-5-a5wr">
                                ...
                                <input class="form-control" placeholder="Enter Contact Numbers" type="text"
                                    name="phone_numbers" id="contact" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-12" data-select2-id="select2-data-5-a5wr">
                             ...
                             <div class="col-lg-12" data-select2-id="select2-data-5-a5wr">
                                ...
                                <select name="type" class="form-control" id="type" required>
                                    ...
                                    <option value="offie">Office</option>
