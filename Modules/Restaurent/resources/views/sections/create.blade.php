    ...
    <div class="modal-dialog"  role="document">
        <div class="modal-content" style="border-radius: 8px;">
            <div class="modal-header justify-content-center" style="background-color: #007bff; color: #ffff;">
                <h4 class="modal-title fs-5" id="staticBackdropLabel">Create Sections </h4>
                <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
            </div>
            <form action="{{ route('sections.store') }}" class="needs-validation" novalidate id="expenseForm" method="post">
                @csrf
                    ...
                    <div class="container">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-12" data-select2-id="select2-data-5-a5wr">
                                <label class="form-label12" for="name">Sections Name <span
                                        class="text-danger">*</span></label>
                                <input class="form-control" placeholder="Enter Sections Name" type="text"
                                    name="name" id="name" required>
                                    <div class="invalid-feedback">
                                        Please Enter Sections Name first!
                                      </div>
                            </div>
