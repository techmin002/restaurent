                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Table/Office/Takeaway</th>
                                            <th class="text-center">Source</th>
                                            <th class="text-center">Status</th>
                                            <th class="text-center">Time</th> <!-- New column -->
                                    ...
                                    <tbody>
                                        @foreach ($orders as $key => $res)
                                            <tr>
                                                    ...
                                                    <table>
                                                        ...
                                                        @foreach ($res->items as $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $item->qty ?? 0 }}</td>
                                                                <td>{{ $variation->price ?? $res->grand_total }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </table>
                                                </td>
                                                ...
                                                <td class="text-center">{{ $res->created_at->format('h:i A') }}</td> <!-- Time column -->
                                                <td>
...
<script>
    $(function () {
        // Initialize DataTable with default sorting on Time column (index 8, descending)
        $("#example1").DataTable({
            "order": [[8, "desc"]],
            "responsive": true,
            "autoWidth": false,
