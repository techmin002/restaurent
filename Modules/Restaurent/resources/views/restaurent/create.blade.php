    ...
    <div class="modal-dialog modal-lg"  role="document">
        <div class="modal-content" style="border-radius: 8px;">
            <div class="modal-header justify-content-center" style="background-color: #007bff; color: #ffff;">
                <h4 class="modal-title fs-5" id="staticBackdropLabel">Create Restaurent </h4>
                <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
            </div>
            <form action="{{ route('restaurent.store') }}" class="needs-validation" novalidate id="expenseForm" method="post">
                @csrf
                <div class="modal-body">
                    <div class="container">
                        <div class="row bg-secondary">
                            <div class="col-md-12">
                                <h5>Restaurent Detail's</h5>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6" data-select2-id="select2-data-5-a5wr">
                                <label class="form-label12" for="name">Restaurent Name <span
                                        class="text-danger">*</span></label>
                                <input class="form-control" placeholder="Enter Restaurent Name" type="text"
                                    name="name" id="name" required>
                                    <div class="invalid-feedback">
                                        Please Enter Restaurent Name first!
                                      </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" placeholder="Enter Title" type="text" minlength="10"
                                    ...
                                    <div class="invalid-feedback">
                                        Please Enter Restaurent Contact Number first!
                                      </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" placeholder="Enter address" type="text" name="address"
                                    id="address" required>
                                    <div class="invalid-feedback">
                                        Please Enter Restaurent Address first!
                                      </div>
                            </div>

                            <div class="col-lg-6">
                                <label class="form-label12" for="email">Email <small>Optional</small></label>
                                <input class="form-control" placeholder="Enter Restaurent email" type="email"
                                    name="email" id="email">
                            </div>
                        </div>
                ...
                <div class="modal-footer justify-content-start d-flex">
                    ...
                    <button type="reset" class="btn btn-danger w-25">Reset Restaurent</button>
                </div>
            </form>
        </div>
    </div>
