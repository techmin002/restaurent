                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ old('access_sidebar_management') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ old('access_restaurent_management') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ old('access_counter_management') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    ...
                                                                    {{ old('access_kitchen_management') ? 'checked' : '' }}>
                                                                <label class="custom-control-label"
