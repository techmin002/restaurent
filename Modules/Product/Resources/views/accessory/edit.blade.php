                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="product-form" action="{{ route('products-accessories.update',$accessory->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    placeholder="Enter Name " value="{{ $accessory->name }}" required>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" class="form-control"
                                                       placeholder="Enter Price" value="{{ $accessory->sales_price }}" required>
                                                @error('price')
                                                <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="summernote" placeholder="Enter Description">{{ $accessory->description }}</textarea>
                                                @error('description')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="feature" class="summernote" placeholder="Enter features">{{ $accessory->feature }}</textarea>
                                                @error('features')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="file-ip-1" accept="image/*"
                                                    class="form-control-file border" value="{{ $accessory->image }}"
                                                ...
                                                <div>
                                                    <img src="{{ asset('upload/images/accessory/'.$accessory->image) }}"  width="200px">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" accept="image/*" multiple
                                                    class="form-control-file border" value="{{ $accessory->images }}" name="images[]">
                                                @error('images')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                                <div>
