    ...
    <div class="modal-dialog modal-lg"  role="document">
        <div class="modal-content" style="border-radius: 8px;">
            <div class="modal-header justify-content-center" style="background-color: #007bff; color: #ffff;">
                <h4 class="modal-title fs-5" id="staticBackdropLabel">Create Category </h4>
                <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
            </div>
            <form action="{{ route('products-categories.store') }}" class="needs-validation" novalidate id="expenseForm" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-footer justify-content-start d-flex">
                    ...
                    <button type="reset" class="btn btn-danger w-25">Reset Category</button>
                </div>
            </form>
        </div>
    </div>
