                                    ...
                                    <div class="card">
                                        <div class="card-header pricing-top-card border-0 font-size-update">
                                            <img src="{{ asset('upload/images/plans/' . $value->image) }}"
                                                ...
                                                style="height: 64px; width: 64px; object-fit: contain;" alt="Plan Image">
                                            <div class="">
                                                <p>{{ $value->title }}</p>
                                                <h4>
                                        ...
                                        <div class="card-body px-4 text-start">
                                                        ...
                                                        <div class="pb-2">
                                                            ...
                                                            @else
                                                                ...
                                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M18.3337 9.99935C18.3337 5.39697 14.6027 1.66602 10.0003 1.66602C5.39795 1.66602 1.66699 5.39697 1.66699 9.99935C1.66699 14.6017 5.39795 18.3327 10.0003 18.3327C14.6027 18.3327 18.3337 14.6017 18.3337 9.99935Z"
                                                                        fill="#FF3B30"></path>
                                                                    <path d="M12.4995 12.5L7.5 7.5M7.50053 12.5L12.5 7.5"
                                            ...
                                            <a class="btn subscribe-plan d-block mt-4 mb-2" data-bs-toggle="modal"
    ...
    <section class="blogs-section">
        <div class="container">
            <div class="section-title d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a data-aos="fade-up" data-aos-delay="300" href="{{ route('frontend.blogss') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="row" id="blogs-container">
                            @foreach ($videos->take(2) as $key => $video)
                                <div class="col-lg-6 pb-4" data-aos="zoom-in" data-aos-delay="{{ $key * 100 }}">
                                    <div class="blog-shadow rounded-16">
                                        ...
                                        <div class="p-3 pt-0">
                                            <div class="d-flex align-items-center mb-2">
                                                <img src="{{ asset('assets/web/frontend/images/icons/clock.svg') }}"
                                                    alt="">
                                                <p class="ms-1 mb-0">
                    ...
                    <div class="col-xl-4">
                        @foreach ($videos->skip(2) as $key => $video)
                            <div class="blog-shadow rounded-16 mb-4" data-aos="zoom-in"
                                data-aos-delay="{{ $key * 100 }}">

                                <div class="blog-sm-main-container">
                                    <div class="blog-sm-container">
                                        <img src="{{ asset($video->thumbnail) }}" class="blog-sm-img"
                                            alt="{{ $video->title }}">
                                    </div>
